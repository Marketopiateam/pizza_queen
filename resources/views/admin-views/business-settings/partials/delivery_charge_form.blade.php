    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center border rounded px-3 py-3">
            ...
            <label class="switcher ml-auto mb-0">
                <input type="checkbox" class="switcher_input change-delivery-charge-type-{{ $branch->id }}"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="fixed_delivery_charge" min="0"
                            max="99999999" step="0.0001"
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center border rounded px-3 py-3">
            <div>
                ...
                <p class="mb-0">
                    {{ translate('Setup delivery charges for per km  and how far you want to deliver from restaurant') }}
                </p>
            </div>
...
<div class="card mt-4" id="kilometerWiseSection-{{ $branch->id }}">
    <div class="card-body">
        <form action="{{ route('admin.business-settings.restaurant.store-kilometer-wise-delivery-charge') }}"
            method="POST">
            @csrf
            <div class="row">
                <input type="hidden" name="branch_id" id="" value="{{ $branch->id }}">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="per_km_charge">{{ translate('Per KM Delivery Charge') }}
                            ({{ Helpers::currency_symbol() }})</label>
                        <input type="number" class="form-control" name="delivery_charge_per_kilometer" min="0"
                            max="99999999" step="0.0001"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="min_distance_free_delivery">{{ translate('Minimum Distance for Free Delivery') }}
                            (Km)</label>
                        <input type="number" class="form-control" name="minimum_distance_for_free_delivery"
                            min="0" max="99999999" step="0.0001"
...
<div class="card my-4">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center border rounded mb-2 px-3 py-3">
            ...
            <label class="switcher ml-auto mb-0">
                <input type="checkbox"
                    class="switcher_input @if ($areaCount > 0) change-delivery-charge-type-{{ $branch->id }} @else change-delivery-charge-to-area-{{ $branch->id }} @endif"
                    name="delivery_charge_type"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-3">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.business-settings.restaurant.delete-area-delivery-charge', [$deliveryArea->id, 'branch_id' => $deliveryArea->branch_id]) }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    <h5 id="editDeliveryChargeModalLabel">{{ translate('Edit Area Name/Zip Code & Delivery Charge') }}
                    </h5>
                </div>
                <div class="my-2">
                        ...
                        <div class="row bg-soft-secondary py-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="deliveryCharge-{{ $branch->id }}"
                                    name="delivery_charge" placeholder="Enter delivery charge">
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="my-2">
                    <form
                        action="{{ route('admin.business-settings.restaurant.store-delivery-wise-delivery-charge') }}"
                        method="POST">
                        @csrf
                        <div class="row bg-soft-secondary py-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="deliveryCharge"
                                        name="delivery_charge" placeholder="Ex: $20" required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="image-uploader mt-4 mx-auto">
                        <div class="image-uploader__zip-preview">
                            <input type="file" name="area_file" class="image-uploader__zip" id="input-file"
                                accept=".xlsx, .xls" required>
                            <img src="{{ asset('/public/assets/admin/img/xlsx-file-upload.svg') }}" alt="">
                            <div>{{ translate('Select File') }}</div>
                        </div>
                        <div class="mt-2 text-center">{{ translate('Format') }} : xlsx, xls <br>
                            {{ translate('Size') }} : {{ translate('Max 2 MB') }}</div>
                        <div class="image-uploader__title collapse">
                            <div class="d-flex flex-wrap gap-2">
                                <img src="{{ asset('/public/assets/admin/img/xlsx-file-upload.svg') }}"
                                    width="20" alt="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <p>{{ translate('You must create atleast one Zipcode & Its Delivery Charge to enable this delivery charge option.') }}
                    </p>
                ...
                <div class="my-2">
                    <form
                        action="{{ route('admin.business-settings.restaurant.store-delivery-wise-delivery-charge', ['change_status' => 1]) }}"
                        method="POST">
                        @csrf
                        <div class="row bg-soft-secondary py-3">
                            <input type="hidden" name="branch_id" class="branchIdInput"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-area').on('click', function() {
                ...
                var actionUrl = '/admin/business-settings/restaurant/update-area-delivery-charge/' +
                    deliveryAreaId;
                $('#editDeliveryChargeForm-' + branchId).attr('action', actionUrl);

                $.ajax({
                    url: '/admin/business-settings/restaurant/edit-area-delivery-charge/' +
                        deliveryAreaId,
                    method: 'GET',
        ...
        $(document).ready(function() {
            $('.import-button-{{ $branch->id }}').on('click', function() {
                ...
                $.ajax({
                    url: '/admin/business-settings/restaurant/import-area-delivery-charge/' +
                        branchId,
                    type: 'POST',
                    data: formData,
                    contentType: false,
