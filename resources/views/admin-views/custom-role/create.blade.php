                            ...
                            <div class="col-xl-4 col-lg-4 col-sm-6">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="{{ $section }}"
                                        class="form-check-input select-all-associate" id="{{ $section }}">
                        ...
                        <form action="" method="GET">
                            <div class="input-group">
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ translate('Search by Role Name') }}"
                                    aria-label="{{ translate('Search') }}" value="{{ $search }}" required=""
                                    autocomplete="off">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switcher">
                                            <input type="checkbox" name="status" class="switcher_input status-change"
                                                {{ $role['status'] == true ? 'checked' : '' }}
                                                data-url="{{ route('admin.custom-role.change-status', ['id' => $role['id']]) }}"
                                                id="{{ $role['id'] }}">
                                    ...
                                    <form action="{{ route('admin.custom-role.delete') }}" method="post"
                                        id="role-{{ $role->id }}">
                                        @csrf
                                        @method('DELETE')
