                        ...
                        <div class="card billing-section-wrap">
                            ...
                            <div class="p-2 p-sm-4">
                                <div class="form-group d-flex gap-2">
                                    <select name="customer_id" data-placeholder="{{ translate('Walk_In_Customer') }}"
                                        class="js-data-example-ajax form-control form-ellipsis customer">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="branch_id" class="js-select2-custom-x form-ellipsis form-control branch"
                                        id="change-branch">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div id="location_map_div">
                                                ...
                                                <div id="location_map_canvas"
                                                    class="overflow-hidden rounded custom-height"></div>
                                            </div>
                                        </div>
                                    @endif
                                @endif
                                        ...
                                        <select name="selected_area_id" class="form-control js-select2-custom-x mx-1"
                                            ...
                                            @foreach ($branch->delivery_charge_by_area as $area)
                                                <option value="{{ $area['id'] }}"
                                                    ...
                                                    - ({{ Helpers::set_symbol($area['delivery_charge']) }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
