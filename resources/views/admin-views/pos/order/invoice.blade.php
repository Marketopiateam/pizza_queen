                    ...
                    <tr>
                        ...
                        @else
                            <div class="font-size-sm text-body">
                                ...
                                <span class="font-weight-bold">{{ Helpers::set_symbol($detail->price) }}</span>
                            </div>
                        @endif
...
<div class="row justify-content-md-end">
    <div class="col-md-9 col-lg-9">
        <dl class="row text-right custom-dl">
            ...
            <dd class="col-6 custom-text-size">
                {{ Helpers::set_symbol($subtotal - $order['coupon_discount_amount'] - $order['extra_discount'] + $deliveryCharge) }}
            </dd>
        </dl>
    </div>
</div>
