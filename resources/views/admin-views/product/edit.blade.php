                    ...
                    $translate[$lang['code']]['description'] = $t->value;
                                            ...
                                            <div class="{{$lang['code'] != 'en' ? 'd-none' : ''}} lang_form"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" {{$lang['status'] == true ? 'required' : ''}}
                                                        name="name[]" id="{{$lang['code']}}_name"
                                    ...
                                    @else
                                        ...
                                        <div class="card p-4" id="english-form">
                                            ...
                                            <div class="form-group pt-4">
                                                <label class="input-label">{{translate('short')}}
                        ...
                        <div class="col-lg-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="font-weight-bold">{{translate('product')}}
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="176" src="{{$product['imageFullPath']}}"
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="input-label"
                                                            for="exampleFormControlSelect1">{{translate('category')}}
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="item_type" class="form-control js-select2-custom"
                                                            id="itemTypeDropdown">
                                                            <option value="0"
                                                                {{$product['set_menu'] == 0 ? 'selected' : ''}}>
                                                                {{translate('product')}} {{translate('item')}}
                                                            </option>
                                                            <option value="1"
                                                                {{$product['set_menu'] == 1 ? 'selected' : ''}}>
                                                                {{translate('set_menu')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="product_type" class="form-control js-select2-custom"
                                                            required>
                                                            <option value="veg"
                                                                {{$product['product_type'] == 'veg' ? 'selected' : ''}}>
                                                                {{translate('veg')}}</option>
                                                            <option value="non_veg"
                                                                {{$product['product_type'] == 'non_veg' ? 'selected' : ''}}>
                                                                {{translate('nonveg')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{$product['price']}}"
                                                            min="0" name="price" class="form-control"
                                                            step="0.01" placeholder="{{translate('Ex : 100')}}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="discount_type" id="discount_type"
                                                            ...
                                                            <option value="not_selected" 
                                                                {{$product['discount_type'] == 'not_selected' ? 'selected' : ''}}>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="input-label" id="discount_label">{{translate('discount')}}
                                                            <span class="text-danger">*</span></label>
                                                        <input type="number" min="0" id="discount"
                                                            value="{{$product['discount']}}" name="discount"
                                                            class="form-control" required placeholder="Ex : 100">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{$product['tax']}}"
                                                            min="0" name="tax" class="form-control"
                                                            step="0.01" placeholder="{{translate('Ex : 7')}}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="stock_type" class="form-control js-select2-custom"
                                                            ...
                                                            <option value="unlimited"
                                                                {{$product->main_branch_product?->stock_type == 'unlimited' ? 'selected' : ''}}>
                                                                {{translate('unlimited')}}</option>
                                                            <option value="daily"
                                                                {{$product->main_branch_product?->stock_type == 'daily' ? 'selected' : ''}}>
                                                                {{translate('daily')}}</option>
                                                            <option value="fixed"
                                                                {{$product->main_branch_product?->stock_type == 'fixed' ? 'selected' : ''}}>
                                                ...
                                                <div class="col-sm-6 d-none" id="product_stock_div">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="product_stock" type="number" name="product_stock"
                                                            class="form-control"
                                                            value="{{$product->main_branch_product?->stock}}"
                        ...
                        <div class="col-lg-6">
                            <div class="row g-2">
                                ...
                                <div class="card-body" id="cardBody"
                                    style="display: {{$product->item_type === '0' ? 'block' : 'none'}};">
                                    <div class="col-12">
                                        <div class="card h-100">
                                            <div class="card-header">
                                                <h4 class="mb-0 d-flex gap-2 align-items-center">
                                            ...
                                            <div class="card-body">
                                                <div class="row g-2">
                                                        ...
                                                        <div class="form-group">
                                                            <label>
                                                                <input type="radio" name="availability_type"
                                                                    value="time"
                                                                    {{$product->available_time_starts ? 'checked' : ''}}>
                                                                {{translate('Time')}}
                                                            </label>
                                                            <label>
                                                                <input type="radio" name="availability_type"
                                                                    value="date"
                                                                    {{$product->available_date_starts ? 'checked' : ''}}>
                                                                {{translate('date')}}
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Time Fields -->
                                                    <div id="time-fields"
                                                        style="display: {{$product->available_time_starts ? 'block' : 'none'}};">
                                                        <div class="form-group">
                                                            <label
                                                            ...
                                                            <input type="time" name="available_time_starts"
                                                                ...
                                                                placeholder="{{translate('Ex : 10:30 am')}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                    ...
                                                    <!-- Date Fields -->
                                                    <div id="date-fields"
                                                        style="display: {{$product->available_date_starts ? 'block' : 'none'}};">
                                                        <div class="form-group">
                                                            <label
                                                                class="input-label">{{translate('available_From')}}</label>
                                                            <input type="date" name="available_date_starts"
                                                                class="form-control"
                                                                value="{{$product->available_date_starts}}"
                                                                placeholder="{{translate('Ex : 2024-12-09')}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                class="input-label">{{translate('available_Till_date')}}</label>
                                                            <input type="date" name="available_date_ends"
                                                                class="form-control"
                                                                value="{{$product->available_date_ends}}"
                                                                placeholder="{{translate('Ex : 2024-12-10')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between gap-3">
                                                <div class="text-dark">
                                                    {{translate('turning recommended status on will show this product in the chef recommended section in user app and website')}}
                                                </div>
                                                <div class="d-flex gap-3 align-items-center">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="">
                                                        <label
                                                            class="input-label">{{ translate('select cuisine') }}</label>
                                                        <select name="cuisines[]" class="form-control js-select2-custom"
                                                            multiple>
                                                            <option value="" disabled>
                                                                ---{{ translate('select cuisine') }}---</option>
                                                            @foreach ($cuisines as $cuisine)
                                                                <option value="{{ $cuisine['id'] }}"
                                                                    {{ $product->cuisines->pluck('id')->contains($cuisine['id']) ? 'selected' : '' }}>
                                                                    {{ $cuisine['name'] }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                ...
                'key' => $key_choice_options + 1,
                            ...
                            <div class="mt-2">
                                <button type="button" class="btn btn-outline-success"
                                    id="add_new_option_button">{{translate('Add_New_Variation')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            function toggleCardBodyVisibility() {
                const selectedValue = $('#itemTypeDropdown').val();
                if (selectedValue === '0') {
                    $('#cardBody').show();
                } else {
                    $('#cardBody').hide();
                    $('#time-fields, #date-fields').hide();
                }
            }

            $('input[name="availability_type"]').on('change', function() {
                const selectedType = $(this).val();
                toggleAvailability(selectedType);
            });
            ...
            function toggleAvailability(type) {
                if (type === 'time') {
                    $('#time-fields').show();
                    $('#date-fields').hide();
                    clearFields('#date-fields');
                } else if (type === 'date') {
                    $('#date-fields').show();
                    $('#time-fields').hide();
                    clearFields('#time-fields');
                }
            }
    ...
    <script>
        ...
        $("#discount_type").change(function () {
            ...
            if (this.value === 'amount') {
                ...
                $("#discount").attr("placeholder", "{{translate('Ex: 500')}}")
            } else if (this.value === 'percent') {
                $("#discount").show();
                $("#discount_label").show();
                $("#discount_label").text("{{translate('discount_percent')}}")
                $("#discount").attr("placeholder", "{{translate('Ex: 50%')}}")
