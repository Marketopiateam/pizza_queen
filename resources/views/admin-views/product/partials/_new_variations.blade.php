    ...
    <div class="card-body">
        <div class="row g-2">
            <div class="col-lg-3 col-md-6">
                ...
                <input required name="options[{{ $key }}][name]" required class="form-control" type="text"
                    onkeyup="new_option_name(this.value,{{ $key }})" value="{{ $item['name'] }}">
            </div>
