                ...
                <div class="card">
                    ...
                    <div class="d-flex flex-wrap flex-md-nowrap justify-content-between gap-3 gap-xl-4 px-4 py-4">
                        <div class="w-100 mr-xl-2">
                            <select name="category" id="category" class="form-control js-select2-custom mx-1 category"
                                ...
                                <div class="input-group input-group-merge input-group-flush border rounded">
                                    <div class="input-group-prepend pl-2">
                                        <div class="input-group-text">
                                            <img width="13"
                                                src="{{ asset('public/assets/admin/img/icons/search.png') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <input id="datatableSearch" type="search" value="{{ $keyword ? $keyword : '' }}"
                                        name="search" class="form-control border-0"
                                        placeholder="{{ translate('Search_here') }}" aria-label="Search here">
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="p-2 p-sm-4">
                        <div class="d-flex flex-row gap-2 mb-3">
                            <select id='customer' name="customer_id"
                                ...
                                class="js-data-example-ajax form-control customer">
                            ...
                            <button class="btn btn-success rounded text-nowrap" id="add_new_customer" type="button"
                                data-toggle="modal" data-target="#add-customer" title="{{ translate('Add Customer') }}">
                                <i class="tio-add"></i>
                                {{ translate('Customer') }}
                            </button>
                        </div>
                            ...
                            <div>
                                <div class="form-control d-flex flex-column-3">
                                    <label class="custom-radio d-flex gap-2 align-items-center m-0">
                                        <input type="radio" class="order-type-radio" name="order_type" value="take_away"
                                    ...
                                    <label class="custom-radio d-flex gap-2 align-items-center m-0">
                                        <input type="radio" class="order-type-radio" name="order_type" value="dine_in"
                    ...
                    <form id='delivery_address_store'>
                        ...
                        <div class="row g-2" id="delivery_address">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="address" id="address" class="form-control" cols="30" rows="3"
                                    placeholder="{{ translate('Ex :') }} address" required>{{ $old ? $old['address'] : '' }}</textarea>
                            </div>
                                ...
                                @if ($deliveryType == 'distance')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="location_map_div">
                                            ...
                                            <div id="location_map_canvas" class="overflow-hidden rounded custom-height">
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <select name="selected_area_id" class="form-control js-select2-custom-x mx-1"
                                        ...
                                        @foreach ($branch->delivery_charge_by_area as $area)
                                            <option value="{{ $area['id'] }}"
                                                {{ isset($old) && $old['area_id'] == $area['id'] ? 'selected' : '' }}
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="btn--container justify-content-end">
                                <button class="btn btn-sm btn-primary w-100 delivery-address-update-button" type="button"
                                    data-dismiss="modal">
...
@push('script_2')
    ...
    <script>
        ...
        function emptyCart() {
            $.post('{{ route('branch.pos.emptyCart') }}', {
                _token: '{{ csrf_token() }}'
            }, function(data) {
                updateCart();
                toastr.info('{{ translate('Item has been removed from cart') }}', {
        ...
        function updateCart() {
            $.post('<?php echo e(route('branch.pos.cart_items')); ?>', {
