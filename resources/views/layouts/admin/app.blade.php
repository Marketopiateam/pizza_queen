...
<body class="footer-offset">
    ...
    {{-- <div class="theme-toggle">
        <svg xmlns="http://www.w3.org/2000/svg" class="theme-icon" viewBox="0 0 24 24" width="24" height="24"
            fill="currentColor">
            <path
                d="M12 4a1 1 0 0 1 0-2 10 10 0 1 1-10 10 1 1 0 0 1 2 0 8 8 0 1 0 8-8zm0 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />
        </svg>
        <span id="currentTheme">Theme</span>
        <i class="fa fa-adjust" onclick="toggleThemeMenu()"></i>
        <span></span>
        <div id="themeMenu" class="theme-menu">
            <button class="btn" style="color: white" onclick="setTheme('light')">Light</button>
            <button class="btn" style="color: white" onclick="setTheme('dark')">Dark</button>
            <button class="btn" style="color: white" onclick="setTheme('system')">System</button>
        </div>
    </div> --}}
